...
export const benefitItems: BenefitItem[] = [
  {
    ...
    description: "99% of people can't self-insure against major medical events or loss of income medical events or loss of income due to injury. Group benefits provide access to essential coverage that would otherwise be unattainable for most Americans.",
